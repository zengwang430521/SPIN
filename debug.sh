...
srun -p 3dv-share -w SH-IDC1-10-198-6-130 \
    ...
    python3 eval.py --checkpoint=data/model_checkpoint.pt --dataset=h36m-p2 --log_freq=20

    python3 eval.py --checkpoint=../pvt_pose/logs/hmr_all/checkpoints/checkpoint_latest.pth --dataset=h36m-p2 --log_freq=20
